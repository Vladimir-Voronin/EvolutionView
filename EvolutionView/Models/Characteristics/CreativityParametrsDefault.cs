...
{
    class CreativityParametrsDefault : ICharacteristicParametrsDefault
    {
        public static bool IsActive = true;
        public static string Name = "Creativity";
        ...
        public static Creativity ReturnNewCharacteristic()
        {
            GeneSeries g = new GeneSeries(CurrentGenes);
            return new Creativity(g);
        }
    }
}
