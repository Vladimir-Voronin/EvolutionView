...
{
    class EmotionalityParametrsDefault : ICharacteristicParametrsDefault
    {
        public static bool IsActive = true;
        public static string Name = "Emotionality";
        ...
        public static Emotionality ReturnNewCharacteristic()
        {
            GeneSeries g = new GeneSeries(CurrentGenes);
            return new Emotionality(g);
        }
    }
}
